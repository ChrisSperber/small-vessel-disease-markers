...
class Cols:
    ...
    FOLLOWUP_MRS_BINARY_GT1: str = "mRS3monBinaryGt1"
    FOLLOWUP_MOCA: str = "MOCA_3mon"
    FOLLOWUP_MOCA_BINARY: str = "MOCA3monBinary"
    FOLLOWUP_RESTROKE: str = "Restroke_Followup"
    YEAR_OF_EDUCATION: str = "YearOfEducation"
    NIHSS_ADMISSION: str = "NIHAdmission"
    NIHSS_24H: str = "NIHSS_24h"
    NIHSS_24H_BINARY_GT4: str = "NIHSS24hBinaryGt4"
    INTRAVENOUS_THROMBOLYSIS: str = "interventionIVT"
    MECHANICAL_THROMBECTOMY: str = "interventionMT"
